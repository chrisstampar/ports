...
ensure_xcode_for_tests() {
    ...
    if [[ "$xp" == *CommandLineTools* ]]; then
        ...
        echo "      3. Point the active developer directory at Xcode (use your real .app name):"
        echo "           ls /Applications/Xcode*.app"
        echo "           sudo xcode-select -s /Applications/Xcode.app/Contents/Developer"
        echo "         (or Xcode-beta.app, or the path from: mdfind 'kMDItemCFBundleIdentifier == \"com.apple.dt.Xcode\"')"
